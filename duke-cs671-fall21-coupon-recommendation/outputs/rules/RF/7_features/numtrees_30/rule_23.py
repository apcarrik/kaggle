def findDecision(obj): #obj[0]: Passanger, obj[1]: Coupon, obj[2]: Education, obj[3]: Occupation, obj[4]: Restaurant20to50, obj[5]: Direction_same, obj[6]: Distance
	...
	if obj[3]>1:
		# {"feature": "Restaurant20to50", "instances": 27, "metric_value": 0.9183, "depth": 2}
		if obj[4]>0.0:
			# {"feature": "Distance", "instances": 24, "metric_value": 0.9544, "depth": 3}
			if obj[6]<=1:
				# {"feature": "Education", "instances": 14, "metric_value": 1.0, "depth": 4}
				if obj[2]>0:
					# {"feature": "Direction_same", "instances": 11, "metric_value": 0.9457, "depth": 5}
					if obj[5]<=0:
						# {"feature": "Coupon", "instances": 10, "metric_value": 0.8813, "depth": 6}
						if obj[1]>0:
