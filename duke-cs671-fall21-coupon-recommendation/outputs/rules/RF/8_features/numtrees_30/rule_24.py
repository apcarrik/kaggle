def findDecision(obj): #obj[0]: Passanger, obj[1]: Coupon, obj[2]: Education, obj[3]: Occupation, obj[4]: Bar, obj[5]: Restaurant20to50, obj[6]: Direction_same, obj[7]: Distance
	...
	if obj[1]>0:
		...
		if obj[3]<=16:
			# {"feature": "Education", "instances": 24, "metric_value": 0.9183, "depth": 3}
			if obj[2]<=3:
				# {"feature": "Distance", "instances": 22, "metric_value": 0.9457, "depth": 4}
				if obj[7]<=2:
					# {"feature": "Bar", "instances": 20, "metric_value": 0.971, "depth": 5}
					if obj[4]>0.0:
						# {"feature": "Passanger", "instances": 12, "metric_value": 1.0, "depth": 6}
						if obj[0]<=1:
